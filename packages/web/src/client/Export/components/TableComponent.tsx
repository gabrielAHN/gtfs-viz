  ...
  const headerContent = (
    <div className="flex items-center w-full">
      <span className="flex items-center">
        {hasData ? isExpanded ? <BiChevronUp size={16} /> : <BiChevronDown size={16} /> : null}
        <span className={hasData ? "ml-1 text-lg font-bold" : "text-lg font-bold"}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 items-center sm:gap-4 mb-2">
              <div className="sm:col-span-1 order-2 sm:order-1 mt-2">
                <div className="flex justify-start space-x-2 flex-wrap gap-y-2">
                  ...
                  {clickInfo && (
                    <Button variant="secondary" onClick={() => mutation.mutate("row")}>
                      <BiUndo className="mr-2 h-5 w-5" />
                      Revert Edit
                    </Button>
                  )}
                  <Button variant="outline" onClick={() => mutation.mutate("table")}>
                                      ...
                                      {col.accessorKey === "status" ? (
                                        ...
                                        flexRender(col.cell, {
                                          row: {
                                            ...
                                            getValue: (key: string) => currentOriginal[key],
                                          },
                                        })
                                      ) : (
                                        value || "-"
