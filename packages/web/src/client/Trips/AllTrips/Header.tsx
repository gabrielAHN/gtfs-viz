  ...
  return (
    <div className="flex flex-col gap-4 mt-2">
      ...
      >
        ...
        />
        <Combobox
          options={availableRouteIds}
          Message="Route"
          value={routeId || ""}
          setValue={(val) => updateSearch({ routeId: val || undefined })}
        />
        <MultiSelect
          options={availableRouteTypes}
        ...
        {hasStopTimes && (
          <div className="grid gap-2 px-1">
            ...
            <Slider
              ...
              onValueChange={(v) =>
                setTimeRange([v[0] ?? sliderBounds[0], v[1] ?? sliderBounds[1]] as [number, number])
              }
            />
          </div>
        )}
      ...
      <div className="flex gap-2">
        <Button
          disabled={!hasActiveFilters && tableSortingCount === 0}
          variant="outline"
