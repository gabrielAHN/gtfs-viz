  ...
  useEffect(() => {
    if (timeIntervalRanges && timeIntervalRanges.length > 0 && !isInitialized) {
      ...
      if (sortedValues.length > 0) {
        logger.log("[Header] Setting initial TimeRange:", [
          sortedValues[0],
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-4">
      ...
      <div className="col-span-1 md:col-span-2 lg:col-span-3 flex flex-col md:flex-row lg:flex-row items-start md:items-center gap-4">
        <div className="flex items-center w-full md:w-auto">
          <Checkbox checked={EmptyConnect} onCheckedChange={(val) => setEmptyConnect(val)} />
        ...
        <div className="w-full">
          {!TimeRange ? (
            ...
            <div className="text-sm text-muted-foreground">No Time Interval Data</div>
          ) : (
            <SmartRangeSlider
