...
- Output vertices do not correspond point-for-point to source vertices after fairing. Measure distance to the selected source polyline (`deviations` in `check-feed.mjs`), not vertex-to-vertex displacement.
